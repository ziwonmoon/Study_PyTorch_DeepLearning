...
## 중요 개념 & 햇갈리는 개념 정리
개념 정리 Website : https://ziwonmoon.github.io/Quartz-Obsidian-AI-Notebook/


## 환경 설정
2025년 11월 13일부로 Google Colab이 VSCode Extension을 정식 지원합니다. 개발환경은 VSCode(Jupyter Notebook Extension, Colba Extension) 입니다.
...
1. ~~Colab에서 Google Drive 마운트 후에 푸시~~
